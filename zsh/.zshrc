...
plugins=(colorize adb ant git brew-cask colored-man-pages golang python safe-paste dircycle docker encode64 jira nyan osx vi-mode zsh-syntax-highlighting zsh-autosuggestions)
